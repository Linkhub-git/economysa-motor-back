...
public class ConstantCore {
	...
	public static final String SWAGGER_BASE_PACKAGE = "com.economysa.motor";
	public static final String SWAGGER_TITLE = "Economysa Api Documentation";
	public static final String SWAGGER_DESCRIPTION = "Documentation for Economysa";
